...
if __name__ == '__main__':
    ...
    ngrok.set_auth_token("2xUBFXtGKNYoxXhGf1kIchbmazI_6VZ8hRGC5PgkjA1nzG22z") # Get this authentication from your NGROK account.
    public_url = ngrok.connect(8080, domain="driven-weasel-advanced.ngrok-free.app") # Get this domain from your NGROK account. Use this to connect to the website.
    print(f" * ngrok tunnel \"{public_url}\" -> http://127.0.0.1:8080")

    # Start Flask server with waitress
    serve(app, host='0.0.0.0', port=8080) # if you use app.run, you must set debug=False. Else will get error.
